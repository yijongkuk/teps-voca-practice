...
- CMUdict 기반 발음기호 표시와 단어 클릭 음성 재생
...
학습장 오른쪽 위의 `단어 테스트`에서 단어장, 학습 기록 범위, 출제 개수를 고른 뒤
새 테스트를 만들 수 있습니다. 단어를 먼저 보고 뜻·예문 셀을 눌러 정답을 확인하고,
...
발음기호가 표시되고, 단어를 누르면 영어 음성을 들을 수 있습니다. 반복 버튼을 누를
때 남은 단어에는 1차, 2차, 3차 기록이 누적되며 일반 단어장에도 최고 차수가
계속 표시됩니다.
